const testDbTxs = [
    { id: '1', date: '2026-02-14', amount: -6800, description: '카카오T일반택시(법인)_4' },
    { id: '2', date: '2026-02-13', amount: -47700, description: '카카오페이' },
    { id: '3', date: '2026-02-10', amount: -10300, description: '카카오T일반택시(법인)_4' },
    { id: '4', date: '2026-02-14', amount: -1900, description: '주식회사 카카오' },
    { id: '5', date: '2026-02-11', amount: -10800, description: '주식회사 카카오' }
];

const kakaoPayRows = [
    { date: '2026.02.14', time: '12:00:00', type: '[-] 결제', merchant: '카카오모빌리티', amount: 6800, currency: 'KRW' },
    ...
    { date: '2026.02.14', time: '18:00:00', type: '[-] 결제', merchant: '정광준', amount: 1900, currency: 'KRW' },
    { date: '2026.02.11', time: '09:00:00', type: '[-] 결제', merchant: '정광준', amount: 10800, currency: 'KRW' }
];
...
for (const tx of testDbTxs) {
    ...
    if (matches.length > 0) {
        // Find exactly one match to see if multiple DB rows are cannibalizing each other
        results.push({ transactionId: tx.id, matchedCount: matches.length, amount: tx.amount });
    }
}
console.log("Results Maps2:", results);
