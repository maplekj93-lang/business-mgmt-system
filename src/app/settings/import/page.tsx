    ...
    return (
        <div className="pb-12">
            <main className="container max-w-4xl mx-auto p-4 md:p-8 space-y-8">
                ...
                <div className="space-y-4">
                    {mappings.length === 0 ? (
                        ...
                        mappings.map((mapping) => (
                            <div key={mapping.id} className="glass-panel p-4 flex flex-col md:flex-row gap-4 items-center animate-in fade-in slide-in-from-top-2">
                ...
                <div className="bg-amber-500/10 border border-amber-500/20 p-4 rounded-lg text-sm text-amber-200/80 flex gap-3">
