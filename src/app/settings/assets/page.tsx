            ...
            <main className="container max-w-6xl mx-auto p-4 md:p-8 space-y-8 animate-in fade-in slide-in-from-bottom-4">
                ...
                <div className="glass-panel overflow-hidden border-white/5 shadow-2xl">
                    <div className="overflow-x-auto">
                        ...
                        {assets.length === 0 && (
                            <div className="p-8 text-center text-muted-foreground border-t border-white/5">
                ...
                <div className="bg-primary/5 border border-primary/20 p-4 rounded-lg flex items-start gap-4 text-sm text-primary/80">
