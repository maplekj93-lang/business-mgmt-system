...
export default async function UnclassifiedInboxPage() {
    ...
    return (
        <div className="space-y-12 animate-in fade-in slide-in-from-bottom-8">
            ...
            <div className="tactile-panel p-1 rounded-lg overflow-hidden">
                <Table>
                                ...
                                <TableRow key={group.rawName + group.amount + group.ownerType + group.type}>
                                    <TableCell className="font-medium">
                                        <div className="flex items-center gap-2">
                                            <Badge variant="outline" className="font-medium text-[11px] bg-muted text-muted-foreground border-0 px-2 py-0.5 whitespace-nowrap shadow-sm">
                                    ...
                                    <TableCell className="text-center">
                                        <Badge variant="secondary" className="bg-muted text-muted-foreground">{group.count}</Badge>
                                    </TableCell>
