    ...
    return (
        <div className="pb-12">
            <main className="container max-w-2xl mx-auto p-4 md:p-8 space-y-8 animate-in fade-in slide-in-from-bottom-4">
                ...
                {/* 실시간 환율 조회 */}
                <div className="tactile-panel p-5 space-y-4">
                    <div className="flex items-center justify-between">
                    ...
                    {liveRates && (
                        <div className="rounded-lg bg-green-500/10 border-green-500/20 p-4 space-y-3">
                ...
                {/* Fallback 환율 편집 */}
                <div className="tactile-panel p-5 space-y-5">
                ...
                {/* 안내 */}
                <div className="bg-primary/5 border-primary/20 p-4 rounded-lg text-sm text-primary/80 flex gap-3">
                    <span>💡</span>
                    <div className="space-y-1">
