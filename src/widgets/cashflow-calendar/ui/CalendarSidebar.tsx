...
export function CalendarSidebar() {
    return (
        <div className="w-80 flex flex-col gap-6 h-full">
            ...
            <div className="tactile-panel p-6 rounded-2xl bg-background">
                <div className="flex items-center gap-3 mb-6">
                    <div className="bg-primary/10 p-2 rounded-lg text-primary">
                        <TrendingUp className="h-4 w-4" />
                    </div>
                    <h3 className="text-xs font-black tracking-widest text-white uppercase">현금 흐름 개요</h3>
                </div>

                <div className="h-24 w-full bg-white/5 rounded-xl flex items-center justify-center relative overflow-hidden">
                    ...
                    <span className="text-[10px] font-black text-slate-500 uppercase tracking-widest relative z-10">실시간 트렌드</span>
                </div>

                <div className="mt-4 flex justify-between">
                    <div>
                        <p className="text-[9px] font-black text-slate-500 uppercase tracking-tight">순 유입액</p>
                        <p className="text-sm font-bold text-white tracking-tight">₩4,250,000</p>
                    </div>
                    <div className="text-right">
                        <p className="text-[9px] font-black text-slate-500 uppercase tracking-tight">성장률</p>
            ...
            {/* AI Forecast Report */}
            <div className="tactile-panel p-6 rounded-2xl bg-background relative overflow-hidden">
                ...
                <div className="flex items-center gap-3 mb-4 relative z-10">
                    ...
                    <h3 className="text-xs font-black tracking-widest text-indigo-400 uppercase">AI 자금 예측 리포트</h3>
                </div>
                ...
                <button className="mt-4 w-full py-2 bg-indigo-500/20 hover:bg-indigo-500/30 text-indigo-400 border-indigo-500/20 rounded-xl text-[10px] font-black uppercase tracking-widest transition-all relative z-10">
                    AI 전체 진단
                </button>
            </div>

            {/* Recent Movements (Small List) */}
            <div className="flex-1 tactile-panel p-6 rounded-2xl bg-background flex flex-col">
