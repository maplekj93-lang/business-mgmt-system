-- [Phase 9.1: Security Hardening - Search Path Enforced]
-- Purpose: Resolve "Function Search Path Mutable" warnings by fixing the search path for all custom functions.

-- 1. Hardening handle_new_user (Auth Trigger)
...
-- 2. Hardening get_dashboard_stats
...
-- 3. Hardening get_filtered_transactions
...
-- 4. Hardening get_advanced_analytics
