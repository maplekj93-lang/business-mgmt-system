-- [Phase 9.2: Final Security Polish - get_dashboard_stats]
-- Purpose: Completely resolve the "Mutable Search Path" warning for get_dashboard_stats by dropping and recreating.

-- 1. Aggressive Drop to clear any signature/return type conflicts
DROP FUNCTION IF EXISTS public.get_dashboard_stats(text);
DROP FUNCTION IF EXISTS public.get_dashboard_stats();

-- 2. Recreate the definitive, hardened version (Integrated Harmony V3)
...
BEGIN
    ...
    LEFT JOIN public.mdt_categories c ON t.category_id = c.id
