...
// These were fetched from DB in previous steps
const CATEGORIES = [
...
const ASSETS = [
    { id: 'bd47d07b-92e6-4a7a-adda-3efd14f00393', name: '의영 개인 / 기업은행' },
    { id: '47b6d489-f490-4035-b7bf-020765c500cc', name: '의영 / 삼성카드' },
    { id: '7ddd455c-3272-4b05-b261-5e71a7af4965', name: '쾅영 / 현대카드' },
    { id: '2fd5c929-b9cb-4bfc-842d-3529e984076c', name: '미담헤어' },
    { id: '169a32c2-e27e-4839-b980-9d03b9317cdd', name: '광영부부 입출금 / 기업은행' },
    { id: 'd07e9251-2139-4e03-89bc-e0d773143e21', name: '광영 생활비 / 국민은행' },
    { id: '43abe80c-7a34-4412-8e72-bd1c91ff9f2d', name: '경조사 / 카카오뱅크' },
    { id: 'c3f01c6b-aa6d-4f7e-a28f-ad6061967ada', name: '수입 / 우리은행' },
    { id: '3855c1b9-549a-4e40-8735-a58639b2fbbf', name: '청년 주택드림 청약통장 / 우리은행' },
    { id: 'c37da565-8429-4505-b178-57c4778ead1e', name: '세이프박스 / 카카오뱅크' },
    { id: '95e40c8c-3d4f-41c7-9fac-c948c59a5364', name: 'KB 주식' },
    { id: 'd2f8a401-949d-47b0-aa6a-31a422ddc1c0', name: 'KB 예수금' },
    { id: 'a717d928-7728-45a1-bb01-9ddcd783451e', name: '광준 / 사업자 삼성카드' },
    { id: 'eed7f701-de1c-43e1-9db1-bb444f13f9fb', name: '광준 / 개인계좌 / 기업은행' },
    { id: 'b9e96c50-5be6-4feb-8f7f-17a8c1db7b8a', name: '광준 / 사업자 계좌 / 기업은행' },
    { id: '36dc3076-ca17-4210-b27f-6c31a720bba2', name: '학자금 광준 / 사업자 / 기업은행' },
    { id: '5f182906-380e-417b-8180-fed72e6721f7', name: '광준 / 기업은행카드' },
    { id: '615ae5ef-253d-4af6-84b5-03470439909b', name: '현금/기타' }
];
...
async function run() {
    ...
    const sqlLines = [
        ...
        'INSERT INTO public.transactions (user_id, category_id, asset_id, allocation_status, amount, date, description, source_raw_data) VALUES'
    ];
    ...
    for (let i = 1; i < rows.length; i++) {
        ...
        values.push(`('${USER_ID}', ${categoryId}, ${assetIdStr}, 'personal', ${finalAmount}, '${date}', '${description}', '${sourceRaw}'::jsonb)`);
    }

    const finalSql = sqlLines.join('\n') + '\n' + values.join(',\n') + ';\nCOMMIT;';

    fs.writeFileSync('2026_import.sql', finalSql);
    console.log(`✨ Generated SQL with ${values.length} transactions at 2026_import.sql`);
}
